...
while true; do
    ...
    1)
        ...
        bash -c "$(wget -nv -O - https://mirror.ghproxy.com/https://github.com/HLLF-FAN/ADSB-scripts/raw/main/readsb-tar1090-zh-install.sh)"
        exit
        ;;
    2)
        ...
        bash -c "$(wget -nv -O - https://mirror.ghproxy.com/https://github.com/HLLF-FAN/tar1090-zh/raw/master/uninstall.sh)"
        fi
    ...
    4)
        echo "正在仅安装 readsb "
        systemctl disable --now readsb
        bash -c "$(wget -O - https://mirror.ghproxy.com/https://github.com/HLLF-FAN/ADSB-scripts/raw/main/readsb-install.sh)"
        exit
        ;;
    5)
        echo "正在仅更新 readsb "
    ...
    7)
        ...
        bash -c "$(wget -nv -O - https://mirror.ghproxy.com/https://github.com/HLLF-FAN/tar1090-zh/raw/master/install.sh)"
        exit
        ;;
    8)
    ...
    10)
        ...
        bash -c "$(wget -O - https://mirror.ghproxy.com/https://github.com/HLLF-FAN/Varilightadsb-upload/raw/main/setup.sh)"
        exit
        ;;
    11)
    ...
    16)
        echo "进入WiFi连接配置"
        sleep 2
        bash -c "$(wget -O - https://mirror.ghproxy.com/https://github.com/HLLF-FAN/ADSB-scripts/raw/main/wifi-configuration.sh)"
        exit
        ;;
    666)
        echo "安装 readsb + tar1090 （中文版）+ 飞常准variflight 数据上传程序"
        bash -c "$(wget -O - https://mirror.ghproxy.com/https://github.com/HLLF-FAN/ADSB-scripts/raw/main/readsb-tar1090-zh-install.sh)"
        sleep 2
        echo "正在安装飞常准variflight 数据上传程序"
        if [[ -f /run/dump1090-fa/aircraft.json ]] ; then
        :
