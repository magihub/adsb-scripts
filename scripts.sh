...
while true; do
    ...
    2)
        ...
        bash -c "$(wget -nv -O - https://ghproxy.com/https://github.com/HLLF-FAN/tar1090-zh/raw/main/uninstall.sh)"
        fi
    ...
    7)
        ...
        bash -c "$(wget -nv -O - https://ghproxy.com/https://github.com/HLLF-FAN/tar1090-zh/raw/main/install.sh)"
        exit
        ;;
    8)
