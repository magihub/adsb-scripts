...
srcdir=/run/readsb
repo="https://github.com/HLLF-FAN/tar1090-zh"
db_repo="https://github.com/HLLF-FAN/tar1090-db"
...
if [[ $lighttpd == yes ]]; then
    ...
    echo "全部完成！您需要自己配置Web服务器，有关nginx配置的参考信息，请参阅 f${ipath}/nginx-tar1090.conf 参考nginx配置"
fi
